  ...
  <div class="col-lg-4"> 
    <div class="panel panel-white post panel-shadow">
      ...
      <div class="post-heading">
        ...
        <div class="pull-left">
          <div class="post-user">
            <a href="account.php?userid=527"><b>Sophia Williams</b></a> <br>
            <span class="text-muted post-time">2w</span>
          </div>
        </div> <!-- User Name --> 
        ...
        <btn data-toggle="tooltip" title="FOLLOW" id="follow527" name="follow527" class="btn btn-sm btn-primary pull-right follow-btn" onclick = "follow(527 , 2, 3)">FOLLOWING</btn>
