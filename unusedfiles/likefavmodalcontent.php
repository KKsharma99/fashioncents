	<div class="notif"> 
		<ul class="updates-list">
			<?php 
				$query = "SELECT a.userid, a.postdate, b.first_name, b.last_name, b.profilepic FROM " . $table . " a LEFT JOIN tbl_users b ON a.userid=b.userid WHERE a.postid = " . $post['postid'] . " ORDER BY a.postdate DESC";
